class ReportsController < ApplicationController
    ...
    def download_experience
        respond_to do |format|
            format.docx { headers["Content-Disposition"] = "attachment; filename=\"experience.docx\"" }
        end
    end
    ...
    def download_report
        # respond_to do |format|
            ...
            # end
            #redirect_to download_experience_path and return if params[:download_type] == 'experience'
            respond_to do |format|
                format.docx { headers["Content-Disposition"] = "attachment; filename=\"reports.docx\"" }
            end
        # end
